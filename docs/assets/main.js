const STRINGS = {
  en: {
    ...
    'hero.lead': 'Warid is a tiny desktop app that records your voice and turns it into clean Arabic or English text in seconds — using your own free Google Gemini key. Press <span class="kbd">Ctrl</span> + <span class="kbd">Shift</span> + <span class="kbd">R</span> anywhere on your computer.',
    ...
    'f.bilingual.d': 'Full RTL support and code-switching. Talk in both languages in the same sentence — Warid handles it.',
    'f.templates.t': 'Custom prompt templates',
    'f.templates.d': 'Transcribe, translate, polish, format emails, write code — each template with its own model and hotkey.',
    ...
    'show.tpl.tag': 'Templates',
    'show.tpl.t': 'One hotkey per use case.',
    'show.tpl.d': 'Make Warid do more than transcribe. Each template carries its own prompt, output language, model, and global hotkey — so the same voice clip can become a polished email or formatted code.',
    ...
    'faq.a1': 'Yes — the app itself is open-source under the MIT license and costs nothing. You\'ll need a free Google Gemini API key, which Google provides on a generous free tier that\'s more than enough for most personal use.',
    ...
    'faq.a3': 'Arabic and English are first-class citizens — including mid-sentence code-switching. Gemini itself supports 100+ languages, so any of them will work for input and output.',
    ...
    'faq.a5': 'So your data stays yours and there are no usage caps we impose. Your key lives in your operating system\'s keychain — Warid just reads it when it needs to make a request.',
  ...
  ar: {
    ...
    'hero.lead': 'وارِد تطبيق سطح مكتب صغير يحوّل صوتك إلى نص عربي أو إنجليزي نظيف في ثوانٍ — باستخدام مفتاح Google Gemini المجاني الخاص بك. اضغط <span class="kbd">Ctrl</span> + <span class="kbd">Shift</span> + <span class="kbd">R</span> من أي مكان.',
    ...
    'f.bilingual.d': 'دعم كامل للكتابة من اليمين لليسار والتبديل بين اللغات. تحدث بكلتا اللغتين في نفس الجملة — وارِد يتعامل معها.',
    'f.templates.t': 'قوالب موجّهة مخصصة',
    'f.templates.d': 'نسخ، ترجمة، تلميع، تنسيق رسائل، كتابة أكواد — كل قالب بنموذجه واختصاره الخاص.',
    ...
    'show.tpl.tag': 'القوالب',
    'show.tpl.t': 'اختصار واحد لكل حالة.',
    'show.tpl.d': 'اجعل وارِد يفعل أكثر من النسخ. كل قالب يحمل موجّهه ولغة الإخراج والنموذج والاختصار العالمي الخاص به.',
    ...
    'faq.a1': 'نعم — التطبيق نفسه مفتوح المصدر بموجب رخصة MIT ولا يكلف شيئاً. ستحتاج إلى مفتاح Google Gemini API مجاني، الذي تقدمه Google بطبقة مجانية سخية تكفي معظم الاستخدام الشخصي.',
    ...
    'faq.a3': 'العربية والإنجليزية مواطنان من الدرجة الأولى — بما في ذلك التبديل في منتصف الجملة. Gemini نفسه يدعم أكثر من 100 لغة، لذا ستعمل أي منها للإدخال والإخراج.',
